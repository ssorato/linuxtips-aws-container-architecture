...
# ECS service is associated to the internal ALB
ssm_alb_arn          = "/linuxtips/ecs/lb/internal/arn"
ssm_alb_listener_arn = "/linuxtips/ecs/lb/internal/listerner/arn"
...
ecs_service = {
  ...
  service_hosts = [
    # "linuxtips.mydomain.fake",
    "app.linuxtips.internal.com" # using intenal DNS domain
  ]
}
...
# container_image variable is declared in the pipeline.

efs_volumes = [
  {
    volume_name      = "ecs-app-efs-volume"
    file_system_root = "/"
    mount_point      = "/mnt/efs"
    read_only        = false
  }
