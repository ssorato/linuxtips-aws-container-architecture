...
module "eks-keda" {
  # source = "git::https://github.com/ssorato/linuxtips-aws-container-architecture-tf-modules.git//eks-keda?ref=day31"
  source = "/Users/ssorato/Documents/dev/git/github/linuxtips/linuxtips-aws-container-architecture-tf-modules/eks-keda"
